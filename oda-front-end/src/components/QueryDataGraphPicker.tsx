...
import { Recommendation, Collection } from "schema-dts";
...
const graphTypes: GraphType[] = [
  ...
  },
  {
    ...
    value: "pieChart",
    image:
      "https://static.anychart.com/images/gallery/v8/pie-and-donut-charts-pie-chart-darkturquoise.png",
    description:
  ...
  },
  {
    ...
    value: "scatterChart",
    image:
      "https://t3.ftcdn.net/jpg/03/76/87/64/360_F_376876441_0qF19cNvPPKODsIxHofT81SzsslFbmkS.jpg",
    description:
  ...
  },
  {
    ...
    value: "radarChart",
    image:
      "https://static.anychart.com/images/gallery/v8/radar-charts-(spiderweb)-comparison-radar-chart-darkturquoise.png",
    description:
      "A chart that consists of a sequence of equi-angular spokes, called radii, with each spoke representing a variable.",
  },
  {
    label: "Radial Chart",
    value: "radialChart",
    image:
      "https://static.wixstatic.com/media/2bbf02_3c5ab7fc51064d11a118421a150b5bcd~mv2.png/v1/fit/w_784%2Ch_832%2Cal_c/file.png",
    description:
      "A chart that consists of a sequence of equi-angular spokes, called radii, with each spoke representing a variable.",
  },
  {
...
function QueryDataGraphPicker() {
  ...
  return (
    <div className="text-xs pt-4">
      ...
      >
        <Tabs.List>
          <Tabs.Tab value="visualization" icon={<Eye size={18} />}>
            Visualizations
          </Tabs.Tab>
          <Tabs.Tab value="table" icon={<Database size={18} />}>
            Table
          </Tabs.Tab>
        </Tabs.List>
        ...
        <Tabs.Panel value="visualization">
          <div className="flex flex-col flex-grow">
            <div>
              ...
              <JsonLd<Recommendation>
                item={{
                  "@context": "https://schema.org",
                  "@type": "Recommendation",
                  name: "Query Data Graph Picker Page",
                  abstract: gptSuggestion,
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <JsonLd<Collection>
                item={{
                  ...
                  collectionSize: graphTypes.length,
                  abstract:
                    "Types of charts that can be generated from the data",
                  inLanguage: "English",
                }}
              />
            </div>
              ...
              <thead>
                <tr className="rounded">
                  {theadData.map((heading) => {
                    return (
                      <th
                        className={`px-4 py-2 sticky border border-solid border-[#1a1a1a] top-0 ${
                  ...
                  return (
                    <tr className="border-spacing-0" key={index}>
                      {theadData.map((key, index) => {
                        return (
                          <td
                            className={`px-4 py-2 border  border-solid border-[#25262b] ${
                              theme.colorScheme === "dark"
                                ? " bg-[#25262b] "
                                : " white "
                            }`}
